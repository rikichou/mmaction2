...
test_save_results_path = 'work_dirs/cnn_lstm_bigger/valid_results_testone.npy'
test_save_label_path = 'work_dirs/cnn_lstm_bigger/valid_label_testone.npy'
...
work_dir = './work_dirs/cnn_lstm_bigger'  # noqa: E501
