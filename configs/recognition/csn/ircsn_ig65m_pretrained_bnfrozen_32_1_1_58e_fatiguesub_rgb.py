...
data_root = 'data/fatigue/sub_train/train'
data_root_val = 'data/fatigue/sub_train/valid'
ann_file_train = 'data/fatigue/sub_train/streamax_train_list_rawframes.txt'
ann_file_val = 'data/fatigue/sub_train/streamax_val_list_rawframes.txt'
ann_file_test = 'data/fatigue/sub_train/streamax_val_list_rawframes.txt'
img_norm_cfg = dict(
