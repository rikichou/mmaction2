...
ann_file_train = '/zhourui/workspace/pro/fatigue/data/clean/fatigue_anns/20211018_fatigue_lookdown_squint.json'
ann_file_val = '/zhourui/workspace/pro/fatigue/data/clean/fatigue_anns/20211018_fatigue_lookdown_squint.json'
ann_file_test = '/zhourui/workspace/pro/fatigue/data/clean/fatigue_anns/20211018_fatigue_lookdown_squint.json'
test_save_results_path = 'work_dirs/fatigue_r50_clean_with_squint/valid_results_testone.npy'
test_save_label_path = 'work_dirs/fatigue_r50_clean_with_squint/valid_label_testone.npy'
...
work_dir = './work_dirs/fatigue_r50_clean_with_squint'  # noqa: E501
