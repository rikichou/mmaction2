...
model = dict(
    backbone=dict(
        ...
        '/zhourui/workspace/pro/source/mmaction2/work_dirs/fatigue_r50_clean_with_squint_smoke_call/epoch_55.pth'  # noqa: E501
    ),
    cls_head=dict(
        num_classes=2
    )
...
work_dir = './work_dirs/fatigue_r50_clean_with_squint_smoke_call_dahaqian'  # noqa: E501
