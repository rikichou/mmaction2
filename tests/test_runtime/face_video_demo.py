...
def init_recognizer_fatigue(config,
                    checkpoint=None,
                    device='cuda:0',
                    use_frames=False):
...
def inference_recognizer_fatigue(model,
                         video_path,
                         label_path,
                         use_frames=False,
                         outputs=None,
...
video_config_file = '/Users/zhourui/workspace/pro/source/mmaction2/configs/recognition/csn/fatigue_r50_clean_inference.py'  # noqa: E501
checkpoint = '/Users/zhourui/workspace/pro/source/mmaction2/work_dirs/fatigue_r50_clean/epoch_58.pth'

# video_config_file = '/Users/zhourui/workspace/pro/source/mmaction2/configs/recognition/csn/fatigue_r50_clean_inference.py'  # noqa: E501
# checkpoint = '/Users/zhourui/workspace/pro/source/mmaction2/work_dirs/fatigue_timesformer_divST_48/epoch_30.pth'

#video_path = '/Users/zhourui/workspace/pro/fatigue/data/test/close_face/face_02_03_0_0_28716278.avi'
video_path = '/Users/zhourui/workspace/pro/fatigue/data/test/lookdown_face/face_02_03_0_0_28716582.avi'
...
def test_video_inference_recognizer():
    ...
    if torch.cuda.is_available():
        ...
        device = 'cpu'
    # model init
    model = init_recognizer_fatigue(video_config_file, checkpoint, device)
    # inference
    scores = inference_recognizer_fatigue(model, video_path, "1")

    print(scores)

test_video_inference_recognizer()